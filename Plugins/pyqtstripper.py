...
def special_case5(import_name='PyQt5', top=False):
    ...
    for folder in os.listdir(os.path.join(folder_path, 'lib', 'PyQt5', 'Qt5', 'plugins')):
        if folder == 'platforms':
            ...
            shutil.rmtree(os.path.join(folder_path, 'lib', 'PyQt5', 'Qt5', 'plugins', folder))
    ...
    for item in remove:
        ...
        try:
            ...
            try:
                os.remove(os.path.join(folder_path, 'lib', 'PyQt5', 'Qt5', 'bin', f'qt5{item}.dll'))
            except FileNotFoundError:
                pass
    for item in remove:
...
def special_case6(import_name='PyQt6', top=False):
    ...
    for folder in os.listdir(os.path.join(folder_path, 'lib', 'PyQt6', 'Qt6', 'plugins')):
        if folder == 'platforms':
            ...
            shutil.rmtree(os.path.join(folder_path, 'lib', 'PyQt6', 'Qt6', 'plugins', folder))
